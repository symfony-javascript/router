import { isTextToken, isVariableToken } from './utils';
...
class Router implements RouterInterface {
  ...
  private getSchemeAndHost(name: string, parameters: any = {}, schemeRelative: boolean = false): string | undefined {
    this.throwIfNotInitialized();
  ...
  public path(name: string, parameters?: any): string {
    ...
    return this.getCollection().baseUrl + ('' === url ? '/' : url) //+ this.getQueryParams(_unused);
  }
